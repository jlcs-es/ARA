...
%TODO: comprobar configuración (direcciones y resto de valores)
\begin{lstlisting}
NodeConfig MN;
DebugLevel 1;
...
%TODO: explicar que en /etc/default/mip6d se indica donde está el fichero del demonio y cómo se inicia.
